<template>
    <tr>
        ...
        <td v-if="rentBook.trangThai == 0"><button class="btn btn-1.5 btn-outline-success" style="color:#EC6F13" @click="TraSach(rentBook)">Xác nhận đã trả</button></td>
        <td v-else class="text-success" ><b>Đã trả sách <i class="fa-solid fa-check"></i></b></td>
    </tr>
</template>
<script>
